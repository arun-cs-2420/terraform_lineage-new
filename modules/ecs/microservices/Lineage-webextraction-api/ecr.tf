...
resource "aws_ecr_repository" "tf_ecr_repository_lineage_web_extraction_api" {
...
resource "aws_ecr_lifecycle_policy" "tf_ecr_policy" {
  ...
  repository = aws_ecr_repository.tf_ecr_repository_lineage_web_extraction_api.name

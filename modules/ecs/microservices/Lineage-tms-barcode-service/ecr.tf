...
resource "aws_ecr_repository" "tf_ecr_repository_lineage_tms_barcode_service" {
...
resource "aws_ecr_lifecycle_policy" "tf_ecr_policy" {
  ...
  repository = aws_ecr_repository.tf_ecr_repository_lineage_tms_barcode_service.name
